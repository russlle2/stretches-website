...
const siteUrl = 'https://gmf-stretch-site2.netlify.app';
...
console.log('Env imported to gmf-stretch-site2');
console.log('Site URL:', siteUrl);
console.log('Admin: https://app.netlify.com/projects/gmf-stretch-site2');
