...
const doc = new Document({
  ...
  sections: [{
    ...
    children: [
      ...
      bullet('Photos & Images — hero background and uploads'),
      ...
      heading1('6. Edit Words on Pages'),
      ...
      heading1('7. Add a News or Promo Page'),
